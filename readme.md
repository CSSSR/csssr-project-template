...
2. Установлен [Visual Studio++ Build Tools Technical Preview](https://www.visualstudio.com/en-us/downloads/update2-prereleases#AdditionalPageSections_66), во время установки выбрать пункт `Modify` и поставить галочки `Windows 8.1 SDK` и `Windows 10 SDK` 
