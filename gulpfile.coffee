...
gulp.task 'watch', ->
	...
	gulp.watch [
		'app/templates/**/*.jade',
		'!app/templates/{helpers,layouts,partials}/**/*'
	], ['jade']
...
gulp.task 'images', ['spritesmith'], -> gulp.start 'imagemin'

gulp.task 'styles', ['images'], -> gulp.start 'stylus'

gulp.task 'all', ['rimraf'], -> gulp.start(
		'styles'
		'jade'
		'browsehappy'
		'replace'
